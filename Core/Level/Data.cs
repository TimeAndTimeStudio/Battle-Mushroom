...
public static class Data_Level
{
    ...
    public static string[] tower_player = new string[] {
    ...
    public static int[] coinwin = new int[] {100,150,200,250,300,350,400,450,500,600};
    public static int[] towerhp = new int[] {100,100,100,100,100,100,100,100,100,100};
    public static int[] sizemap = new int[] {15,15,15,15,15,15,15,15,15,15};

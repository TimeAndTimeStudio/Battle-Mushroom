...
public static class Data_Level
{
    ...
    public static int[] coinwin = new int[] {100,150,200,250,300};
    public static int[] towerhp = new int[] {100,100,100,100,100};
    public static int[] sizemap = new int[] {15,15,15,15,15};

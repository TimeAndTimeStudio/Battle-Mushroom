public static class Data_Enemy
{
    ...
    public static int?[][] spawnenemy_cooldown = new int?[][]
    {
        ...
        new int?[] {3,5,4,5,5,4,3,4,5,9,7,5,4,2,5,4,8,9,4,7,6,5,3,5,4},
        new int?[] {3,5,4,5,5,4,3,4,5,9,7,5,4,2,5,4,8,9,4,7,6,5,3,5,4,9,4,7},
        new int?[] {3,5,4,5,5,4,3,4,5,1,2,5,4,2,5,4,4,3,4,5,6,5,3,5,4,2,5,3,4,2,2,2},
        new int?[] {3,5,4,5,5,4,3,4,5,1,2,5,4,2,5,4,4,3,4,5,6,5,3,5,4,2,5,3,4,2,2,2,5,3,2},
        new int?[] {3,5,4,5,5,4,3,4,5,1,2,5,4,2,5,4,4,3,4,5,6,5,3,5,4,2,5,3,4,2,2,2,5,3,2,5,3,2}
    };

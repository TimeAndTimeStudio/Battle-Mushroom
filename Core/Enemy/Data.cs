public static class Data_Enemy
{
    ...
    public static int?[][] spawnenemy = new int?[][]
    {
        ...
        new int?[] {1,0,1,0,1,2,2,1,0,2,2,0,0,1,1,1,0,1,2,1,1,2,0,0,2,1,2,2,1,0,2,2,0,2,1,1,2,2,2,0,2,1},
        new int?[] {1,0,1,0,1,2,2,1,0,2,2,0,0,1,1,1,0,1,2,1,1,2,0,0,2,1,2,2,1,0,2,2,0,2,1,1,2,2,2,0,2,1,2,1,0,2,2,0}
    };
    public static int?[][] spawnenemy_cooldown = new int?[][]
    {
        new int?[] {2,1,3,2,4,1},
        new int?[] {1,3,2,4,1,2,3,1,4},
        new int?[] {2,1,4,2,3,1,2,4,1,3,2,1,4,2,3,5},
        new int?[] {1,2,3,1,4,2,1,3,2,4,1,2,3,1,4,2,1,3,5},
        new int?[] {2,1,3,2,4,1,2,3,1,4,2,1,3,2,4,1,2,3,1,4,2,5},
        new int?[] {1,3,2,4,1,2,3,1,4,2,1,3,2,4,1,2,3,1,4,2,1,3,2,4,5},
        new int?[] {2,1,4,2,3,1,2,4,1,3,2,1,4,2,3,1,2,4,1,3,2,1,4,2,3,1,2,5},
        new int?[] {1,2,3,1,4,2,1,3,2,4,1,2,3,1,4,2,1,3,2,4,1,2,3,1,4,2,1,3,2,4,5},
        new int?[] {2,1,3,2,4,1,2,3,1,4,2,1,3,2,4,1,2,3,1,4,2,1,3,2,4,1,2,3,1,4,2,1,3,5},
        new int?[] {1,3,2,4,1,2,3,1,4,2,1,3,2,4,1,2,3,1,4,2,1,3,2,4,1,2,3,1,4,2,1,3,2,4,1,2,3,5},
        new int?[] {2,1,4,2,3,1,2,4,1,3,2,1,4,2,3,1,2,4,1,3,2,1,4,2,3,1,2,4,1,3,2,1,4,2,3,1,2,4,1,3,2,5},
        new int?[] {1,2,3,1,4,2,1,3,2,4,1,2,3,1,4,2,1,3,2,4,1,2,3,1,4,2,1,3,2,4,1,2,3,1,4,2,1,3,2,4,1,2,3,1,4,2,1,5}
    };

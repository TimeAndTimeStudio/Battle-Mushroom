...
public class Docs : Scene
{
    ...
    public override void Draw(SpriteBatch _spriteBatch, GraphicsDevice graphicsDevice)
    {
        ...
        if (page == "p" && player_select != null)
        {
            _spriteBatch.Draw(color1,new Rectangle((int)(height / 16f) ,(int)(height / 2.5f - ((int)(height / 3f / 2f))),(int)(height / 3f),(int)(height / 3f)), new Color(255,255,255));
            _spriteBatch.Draw(color3,new Rectangle((int)(height / 16f) + (int)(height / 3f / 2f) - (int)(height / 3.5f / 2f),(int)(height / 2.5f - ((int)(height / 3.5f / 2f))),(int)(height / 3.5f),(int)(height / 3.5f)), new Color(255,255,255));
            _spriteBatch.Draw(icon_load[player_select.Value],new Vector2((int)(height / 16f) + (int)(height / 3f / 2f) - (int)(height / 3.5f / 2f),(int)(height / 2.5f - ((int)(height / 3.5f / 2f)))), null, new Color(255,255,255), 0, Vector2.Zero,(height / 3.5f) / Data_Player.player_size_icon[player_select.Value],SpriteEffects.None,0);

            ThaiTextRenderer.DrawString(_spriteBatch,Data.Tiny5,BattleMushroom.Language.TimeAndTime.ATK + Data_Player.attackd[player_select.Value] + $" + {Data_Player.attack[player_select.Value] - Data_Player.attackd[player_select.Value]}",new Vector2((int)(height / 16f) + (int)(height / 3f) + (int)(height / 16f / 4f),(int)(height / 2.5f - ((int)(height / 3f / 2f)))),rgb_color1,0,Vector2.Zero,(height / 12f / 96f) / 1.5f,SpriteEffects.None,0);
            ThaiTextRenderer.DrawString(_spriteBatch,Data.Tiny5,BattleMushroom.Language.TimeAndTime.HP + Data_Player.hpd[player_select.Value] + $" + {Data_Player.hp[player_select.Value] - Data_Player.hpd[player_select.Value]}",new Vector2((int)(height / 16f) + (int)(height / 3f) + (int)(height / 16f / 4f),(int)(height / 2.5f - ((int)(height / 3f / 2f))) + (int)(fontheight * (height / 12f / 96f / 1.5f))),rgb_color1,0,Vector2.Zero,(height / 12f / 96f) / 1.5f,SpriteEffects.None,0);
        ...
        } else if (page == "p")
        {
            for (int i = 0; i < Data_Player.player_list.Length; i++)
            {
                ...
                if (icon_load[i] != null)
                {
                    _spriteBatch.Draw(icon_load[i],new Vector2((int)x + (int)(height / 16f) + (int)(height / 16f / 2f * i) + (int)(height / 3f * i) + (int)(height / 3f / 2f) - (int)(height / 3.5f / 2f),(int)(height / 2.5f - ((int)(height / 3.5f / 2f)))), null, new Color(255,255,255), 0, Vector2.Zero,(height / 3.5f) / Data_Player.player_size_icon[i],SpriteEffects.None,0);
                }
            }
        }
